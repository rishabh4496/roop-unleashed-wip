...
export default function PresetStudioModal({
  ...
  const CURATED_RECIPES = [
    ...
    {
      id: 'ultramax_studio',
      title: 'UltraMax Multi-Pass Studio',
      desc: 'Next-gen composite facial enhancement combining dual-pass restoration with fine detail preservation.',
      badge: 'ULTRAMAX AI',
    ...
    {
      id: 'gpen_realistic',
      title: 'GPEN Realistic Portrait',
      desc: 'Photorealistic facial fidelity using GPEN-BFR neural alignment and natural texture preservation.',
      badge: 'PHOTOREAL',
