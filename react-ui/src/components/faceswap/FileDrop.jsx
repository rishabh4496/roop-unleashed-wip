  ...
  return (
    ...
    >
      <motion.div
        ...
        className={`px-4 py-3.5 rounded-xl border-2 border-dashed text-center transition-colors duration-200 ${busy ? 'border-[var(--accent)]/60 bg-[var(--accent)]/[0.06]' : drag ? 'border-[var(--accent)]/70 bg-[var(--accent)]/[0.10] shadow-[0_0_30px_var(--accent-glow)]' : 'border-white/15 hover:border-[var(--accent)]/50 hover:bg-white/[0.02]'}`}
      >
        {busy ? (
