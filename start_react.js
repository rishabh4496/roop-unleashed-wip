    ...
    run: [
      {
        ...
        params: {
          ...
          env: {
            ...
            // tracked face is moving. Only quiet frames are linearly filled, so
            // head turns keep the step=1 quality path without paying for it on
            // every frame of a stable shot. Use "1" for an unconditional
            // every-frame scan, or a numeric value for the legacy fixed stride.
            ROOP_TEMPORAL_STEP: "auto",
