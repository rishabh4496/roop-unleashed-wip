...
def preview(payload: dict = Body(...)):
    ...
    roop_globals.yaw_align = payload.get("yaw_align", getattr(roop_globals.CFG, "yaw_align", 'pose'))   # mode name, not a bool
    roop_globals.angle_visibility_mask = bool(payload.get("angle_visibility_mask", getattr(roop_globals.CFG, "angle_visibility_mask", True)))
    roop_globals.angle_fade_strength = float(payload.get("angle_fade_strength", getattr(roop_globals.CFG, "angle_fade_strength", 65.0)))
